...
# Big Tickets 
Ak: Job was to Add CSS to the API, meme page, and the Who am I page. He also had to get a head start on passing data, all he has to do is add commands in the terminal. [Big ticket https://github.com/LordRoop/P4-Ducks/projects/1]
